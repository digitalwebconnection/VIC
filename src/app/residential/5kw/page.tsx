   ...
   <>
            <div className=" bg-white p-6 md:p-12">
                <div className="max-w-7xl mx-auto   grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
                    <div className=" ">
                        {/* Header */}
                        <h1 className="text-3xl md:text-4xl font-bold text-blue-900 mb-2">5kw Solar System</h1>
                        ...
                        <p className="text-gray-700 mb-8">
                            The powerful 5kw solar power system is an ideal residential solar solution for the small homeowners
