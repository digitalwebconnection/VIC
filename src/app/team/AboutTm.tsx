                ...
                <div className=" space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="flex justify-center">
                            <div className="absolute md:w-72 md:h-74 w-58 h-60 border-[30px] border-yellow-400 rounded-full z-10 -mt-4 ms-3"
                                style={{
                            ...
                            ></div>
                            {/* Gray Circle */}
                            <div className="md:w-64 md:h-64 w-50 h-50 bg-gray-600 rounded-full relative z-0 ms-4">
                                <img src="https://images.rawpixel.com/image_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvcm01MTktbS0wMV8xLWwxazFqajl6LmpwZw.jpg" alt="" className=" z-0 md:w-64 md:h-64 w-50 h-50 bg-gray-600 rounded-full relative" />
                            </div>
                        </div>
                ...
                <div className=" bg-white  py-10">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed mb-6">
                            ...
                            Duis aute irure anim id est laborum nisi ut aliquip ex ea commodo consequat. Dolore magna aliqua.
                            Ut enim ad minim veniam, quis nostrud exercitation ullamco labip exaeco oris nisi ut aliquip ex ea commodo consequat.
                            Duis au te irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum nisi ut aliquip ex ea commosi ut aliquip
                        </p>
                        <p className="text-sm text-gray-600 leading-relaxed mb-8">
                            aliquip ex ea commodo consequat. Dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labip exaeco oris nisi ut aliquip ex ea commodo consequat.
                            Duis au te irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum nisi ut aliquip ex ea commosi ut aliquip
                        </p>
                        ...
                        <ul className="space-y-4">
                            {points.map((point, index) => (
                                <li key={index} className="flex items-start space-x-3">
                                    <CheckCircleIcon className="h-5 w-5 text-black-600 mt-1" />
