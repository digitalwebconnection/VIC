      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex justify-center relative">
            <div
              className="absolute md:w-72 md:h-74 w-58 h-60 border-[30px] border-yellow-400 rounded-full z-10 -mt-4 ms-3"
              style={{
                clipPath: "polygon(0 0%, 100% 0, 100% 70%, 0 40%)",
                transform: "rotate(190deg)"
              }}
            ></div>
            <div className="md:w-64 md:h-64 w-50 h-50 bg-gray-600 rounded-full relative z-0 ms-4 overflow-hidden">
              <Image
                ...
                alt="Profile Picture"
                width={256} // matching md:w-64
                height={256} // matching md:h-64
