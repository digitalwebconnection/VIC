    ...
    <footer className="bg-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10">
        ...
        <div className="grid gap-10 lg:gap-14 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="text-[15px] leading-7 text-white/85">
              West VIC Energy designs and installs quality rooftop solar and battery systems across Victoria.
              We focus on trusted Tier-1 products, neat workmanship, and responsive after-sales support—so you
              get reliable savings and a smooth experience end-to-end.
            </p>
          </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          ...
          <Pill icon={<MailIcon />} title="Email" text={<a href="mailto:admin@westvicenergy.com.au">admin@westvicenergy.com.au</a>} />
        </div>
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <div className="text-[11px] tracking-wide text-white/70">SOLAR • BATTERY • EV</div>
      </div>
    </div>
  )
}
