...
export const metadata = {
  title: "Sungrow Solar Battery – Series Specs | West Vic Energy",
  description:
    "West Vic Energy provides Sungrow SBR (3.2 kWh modules) and SBH (5 kWh modules) specs plus warranty, chemistry, maintenance, and monitoring.",
};
      ...
      <main className="bg-white text-gray-800">
        <section className="relative mx-auto max-w-7xl px-6 md:px-0 py-12 md:py-16">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-blue-900">
            Sungrow Solar Battery – Powered by West Vic Energy
          </h1>

          {/* Subheading */}
          <p className="mt-4 text-lg md:text-xl font-semibold text-gray-900">
            Start storing your excess solar power and reducing your electricity bills further with West Vic Energy.
          </p>

          {/* Company Intro */}
          <div className="mt-6 bg-blue-50 border-l-4 border-blue-600 p-6 rounded-xl">
            <h2 className="text-2xl font-bold text-blue-900">About West Vic Energy</h2>
            <p className="mt-2 text-gray-700 leading-relaxed">
              At <strong>West Vic Energy</strong>, we are committed to delivering reliable and sustainable solar and battery solutions across Victoria and beyond. As a trusted local installer, we partner with industry leaders like <strong>Sungrow</strong> to provide high-quality, efficient, and future-ready energy storage systems for homes and businesses.
            </p>
          </div>
        ...
        <main className="bg-white text-gray-900">
          <section className="mx-auto max-w-7xl px-6 md:px-0 py-12 md:py-16">
            ...
            <div className="mt-16 text-center">
              <h2 className="text-2xl font-bold text-blue-900">Why Choose West Vic Energy?</h2>
              <p className="mt-4 text-gray-700 max-w-2xl mx-auto">
                With years of expertise and a strong commitment to renewable energy, <strong>West Vic Energy</strong> ensures that your solar and battery systems deliver maximum savings, reliability, and long-term value. Partner with us today for a smarter, cleaner energy future.
              </p>
            </div>
          </section>
        </main>
