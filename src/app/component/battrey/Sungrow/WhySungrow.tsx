...
export const metadata = {
  title: "Why Choose Sungrow Solar Battery? | West Vic Energy",
  description:
    "West Vic Energy offers Sungrow batteries with safe LFP chemistry, modular scalability, high efficiency & fast delivery, smart EMS/iSolarCloud monitoring, and compact design.",
};
        ...
        <section className="mx-auto max-w-7xl px-6 md:px-0 py-8 md:py-10">
          <div className="rounded-2xl bg-slate-100/80 p-6 md:p-9 ring-1 ring-slate-200 shadow-2xl">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-blue-900">
              Why Choose Sungrow Solar Battery with West Vic Energy?
            </h1>
            ...
            <div className="mt-6 bg-blue-50 border-l-4 border-blue-600 p-6 rounded-xl">
              ...
              <p className="mt-2 text-gray-700 leading-relaxed">
                At <strong>West Vic Energy</strong>, we are passionate about delivering high-performance solar and battery systems. By partnering with global leaders like <strong>Sungrow</strong>, we ensure our customers gain access to safe, efficient, and scalable energy solutions that lower bills and support a sustainable future.
              </p>
            </div>
