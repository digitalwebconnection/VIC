// app/alpha-ess/page.tsx
import Image from "next/image";
import { CheckCircle } from "lucide-react";

export const metadata = {
  title: "Alpha ESS Solar Battery",
  description:
    "Alpha ESS LiFePO4 battery – modular & scalable design, hybrid inverter + UPS functionality, advanced BMS, and high energy efficiency.",
};

export default function HeroAlphaESS() {
  return (
      ...
      <div className="relative container mx-auto px-6 md:px-25 flex flex-col md:flex-row items-center justify-between z-10">
        ...
        <div className="max-w-xl">
          ...
          <ul className="space-y-3 my-6 text-lg">
            {[
              "Safe & Reliable LiFePO₄ Chemistry",
              "Modular & Scalable Design",
              "Integrated Hybrid Inverter & UPS Functionality",
              "Advanced BMS with Minimal Degradation",
              "High Energy Efficiency & Intelligent Management",
            ].map((item) => (
        ...
        <div className="mt-10 md:mt-0 w-full md:w-auto">
          <Image
            src="https://www.solarminer.com.au/wp-content/uploads/2025/07/Ap-img.png" // replace with your battery image
