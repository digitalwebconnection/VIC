    ...
    return(
        ...
        <div className=" bg-white p-6 md:p-12">
                <div className="max-w-7xl mx-auto   grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
                    <div className="">
                        {/* Header */}
                        <h1 className="text-3xl md:text-4xl font-bold text-blue-900 mb-2">Hybrid Solar System</h1>
                        ...
                        <h2 className="text-lg font-semibold text-blue-500 mb-6">
                            The Most Sold Hybrid Solar System Solar Power System Package for Queensland Households
                        </h2>

                        {/* Description */}
                        <p className="text-gray-700 mb-8">
                            The powerful Hybrid Solar System solar power system is an ideal residential solar solution for the small homeowners
