    ...
    <>
      <div className="max-w-7xl mx-auto my-12 px-6 md:px-0">
        ...
        <p className="text-center text-gray-600 mb-10 max-w-3xl mx-auto">
          At <span className="font-semibold">West Vic Energy</span>, we ensure your 10kW Solar System is protected with
      ...
      <div className="w-full bg-gradient-to-r from-amber-400 to-yellow-400 py-8 px-6 text-center">
        ...
        <p className="text-gray-800 mb-6">
          Book a <span className="font-bold">free 30-minute solar consultation</span> today and learn how a 10kW
