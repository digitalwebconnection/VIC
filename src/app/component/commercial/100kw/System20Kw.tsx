...
export default function System100kw() {
  const warrantyCards = [
    ...
    {
      title: "Workmanship & Replacement Warranty for 100kw Solar System Panels",
      color: "bg-sky-800",
      text: "text-white",
    },
    {
      title: "Product Warranty on 100kw Solar System with 50kW Solar Panels",
      color: "bg-amber-400",
      text: "text-black",
    },
    {
      title: "100kw Solar System Packages Available On-Demand",
      color: "bg-sky-800",
      text: "text-white",
    },
  ];
    ...
    <>
      <div className="max-w-full mx-auto my-10">
        <h2 className="text-center text-2xl font-bold mb-8 text-gray-900">
          Excellent Warranty Coverage on 100kw Solar System
        </h2>
