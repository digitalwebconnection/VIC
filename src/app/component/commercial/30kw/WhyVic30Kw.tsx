export default function WhyVic30Kw() {
    return(
             <>
                ...
                <div className="max-w-7xl w-full grid md:grid-cols-2 gap-15">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h2 className="text-2xl font-bold mb-4 text-gray-900">
                            Salient Features of 30kW Solar System
                        </h2>
                        <ul className="list-none space-y-3 mb-8">
                            ...
                            <li className="flex items-start">
                                <span className="text-green-500 mr-3 mt-1">✔</span>
                                System configured by best 30kW Solar System installation and maintenance team in Queensland
                            </li>
                        </ul>

                        {/* Technical Specifications */}
                        <h2 className="text-2xl font-bold mb-4 text-gray-900">
                            Technical Specifications for 30kW Solar System
                        </h2>
                        <ul className="list-none space-y-3 mb-6">
                            ...
                            <li className="flex items-start">
                                <span className="text-green-500 mr-3 mt-1">✔</span>
                                <strong>Inverter:</strong> 30kW inverter manufactured by reputed companies & recommended by CEC-accredited technicians
                            </li>
                            <li className="flex items-start">
                                <span className="text-green-500 mr-3 mt-1">✔</span>
