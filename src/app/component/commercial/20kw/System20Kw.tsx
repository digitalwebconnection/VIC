...
export default function System20Kw() {

 const warrantyCards = [
        {
            title: "Performance Warranty on 20kW Solar System",
            color: "bg-amber-400",
        },
        {
            title: "Workmanship & Replacement Warranty for 20kW Solar System Panels",
            color: "bg-blue-500",
        },
        {
            title: "Product Warranty on 20kW Solar System with 30kW Solar Panels",
            color: "bg-amber-400",
        },
        {
            title: "20kW Solar System Packages Available On-Demand",
            color: "bg-blue-500",
        },
    ];
    return (
        <>
            ...
            <div className="max-w-full mx-auto my-10 ">
                <h2 className="text-center text-2xl font-bold mb-8 text-gray-900">
                    Excellent Warranty Coverage on 20kW Solar System
                </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-4 gap-6 mb-8">
                    {warrantyCards.map((card, index) => (
                        ...
                        >
                            ...
                            {/* Optional background icon can be added here */}
            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row justify-end items-center gap-2 w-full">
                    <button className=" absolute z-0 bg-amber-400 w-full text-white px-6 py-3 font-semibold rounded  transition">
                     ...
                     <div className="flex items-center justify-center w-full sm:w-auto me-70  my-10  pe-0 md:pe-90">
                        <a
                            ...
                            className="flex items-center z-10 relative md:-mb-0 -mb-40  h-15 px-15 bg-sky-800 text-white py-4 font-semibold rounded hover:bg-sky-600 transition"
                        >
